...
1. 缓存一致性协议
1. 循环优化之Loop Tiling，还写了一下文档，耗了好长时间
1. CSAPP 系列课程 CMU 第17节课 Virtual Memory Concept 
...
1. 计网 第13课 TCP客户端服务器模型看了一半（之后再补）
1. 自顶向下方法的运输层的前一小部分
1. 并行计算导论第三章第一部分
...
### 5.16
  - 修复硬盘
### 5.17
  - AcWing算法提高课：背包问题的前6道题和1019、8、1020
